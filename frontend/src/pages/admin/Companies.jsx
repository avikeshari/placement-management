...
const Companies = () => {
  ...
  const remove = async () => {
    ...
    try { setDeleting(true); await api.delete(`/admin/users/${deleteTarget._id}`); setCompanies((items) => items.filter((item) => item._id !== deleteTarget._id)); toast.success("Company deleted successfully"); setDeleteTarget(null); }
